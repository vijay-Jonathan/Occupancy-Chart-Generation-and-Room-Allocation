...
<form  action="faculty_workshop.php" method="post">
<div  align="center" class="form-group">
    <label for="class_room_no">LAB SELECTION AND WORKSHOP ALLOCATION</label>
        <select name="lab_room" class="list-group-item">
            <option selected disabled>Select or View Lab</option>
            <?php
            $q = mysqli_query($conn,
                "SELECT * FROM lab ");
            while ($row = mysqli_fetch_assoc($q)) {
                echo " \"<option value=\"{$row['lab_name']}\">{$row['lab_name']}</option>\"";
            }
            ?>

        </select>
        <button type="submit" id="viewsemester" style="margin-top: 5px" class="btn btn-success btn-lg">View Lab
        </button>
...
<form action="allot_workshop.php" method="post">
    <div align="center" style="margin-top: 30px">
     ...
     <option selected disabled>Select LAB </option>';
                while ($row = mysqli_fetch_assoc($q)) {
                    $mystring .= '<option value="' . $row['lab_name'] . '">' . $row['lab_name'] . '</option>';
                }
        ...
        <button type="submit" id="viewteacher" class="btn btn-success btn-lg" style="margin-top: 5px">Allot Workshop
        </button>
    </div>
</form>
...
<form action="cancel_workshop.php" method="post">
    <div align="center" style="margin-top: 30px">
     ...
     <option selected disabled>Select LAB </option>';
        ...
        <button type="submit" id="viewteacher" class="btn btn-success btn-lg" style="margin-top: 5px">Cancel Workshop
        </button>
    </div>
</form>
