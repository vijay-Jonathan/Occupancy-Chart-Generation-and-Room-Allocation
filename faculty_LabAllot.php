...
<form  action="faculty_LabAllot.php" method="post">
<div  align="center" class="form-group">
    <label for="class_room_no">LAB SELECTION AND ALLOCATION</label>
...
<form action="allot_lab.php" method="post">
    <div align="center" style="margin-top: 30px">
     ...
     <option selected disabled>Select LAB </option>';
        ...
        <button type="submit" id="viewteacher" class="btn btn-success btn-lg" style="margin-top: 5px">Allot Lab
        </button>
    </div>
</form>
...
<form action="cancel_lab.php" method="post">
    <div align="center" style="margin-top: 30px">
     ...
     <option selected disabled>Select LAB </option>';
        ...
        <button type="submit" id="viewteacher" class="btn btn-success btn-lg" style="margin-top: 5px">Cancel Lab
        </button>
    </div>
</form>
