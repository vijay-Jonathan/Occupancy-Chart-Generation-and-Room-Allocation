...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 22, 2020 at 08:29 PM
...
--
-- Table structure for table `a204`
--
...
--
-- Dumping data for table `a204`
--

INSERT INTO `a204` (`day`, `period1`, `period2`, `period3`, `period4`, `period5`, `period6`) VALUES
('Friday', '', '', '', '', '', ''),
('Monday', '', '', '', '', '', ''),
('Thursday', '', '', '', '', '', ''),
('Tuesday', '', '', '', '', '', ''),
...
--
-- Dumping data for table `b203`
--

INSERT INTO `b203` (`day`, `period1`, `period2`, `period3`, `period4`, `period5`, `period6`) VALUES
('Friday', '', '', '', '', '', ''),
('Monday', '', '', '', '', '', ''),
('Thursday', '', '', '', '', '', ''),
('Tuesday', '', '', '', '', '', ''),
...
--
-- Table structure for table `c403`
--
...
--
-- Dumping data for table `c403`
--

INSERT INTO `c403` (`day`, `period1`, `period2`, `period3`, `period4`, `period5`, `period6`) VALUES
('friday', '', '', '', '', '', ''),
('monday', '', '', '', '', '', ''),
('thursday', '', '', '', '', '', ''),
('tuesday', '', '', '', '', '', ''),
...
('ML11', 0, 0, '', '', ''),
('B203', 60, 1, 'Yes', 'No', 'Yes'),
('A204', 50, 3, 'Yes', 'Yes', 'Yes'),
('C403', 50, 3, 'Yes', 'Yes', 'Yes');
...
INSERT INTO `sections` (`sec_name`, `sec_strength`) VALUES
('CSEA', 69);
...
--
-- Error reading structure for table ttms.student_info: #1932 - Table 'ttms.student_info' doesn't exist in engine
-- Error reading data for table ttms.student_info: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'FROM `ttms`.`student_info`' at line 1
...
('monday', '-<br>-', 'CO206<br>', '-<br>-', '-<br>-', '-<br>-', '-'),
('tuesday', '-<br>-', '-<br>-', '-<br>-', '-<br>-', '-<br>-', 'CO493'),
('wednesday', 'CO206<br>', '-<br>-', '-<br>-', '-<br>-', '-<br>-', '-'),
('thursday', '-<br>-', '-<br>-', '-<br>-', '-<br>-', '-<br>-', '-'),
('friday', 'CO206<br>', '-<br>-', '-<br>-', '-<br>-', '-<br>-', '-'),
('saturday', '-<br>-', '-<br>-', '-<br>-', 'CO206<br>', '-<br>-', 'CO493');
...
('monday', '-<br>-', 'CO309<br>ML11', '-<br>-', '-<br>-', '-<br>-', 'CO393'),
('tuesday', 'CO451<br>', 'CO207<br>', 'CO406<br>', '-<br>-', '-<br>-', 'CO292'),
('wednesday', 'CO309<br>ML11', 'CO207<br>', '-<br>-', 'CO451<br>', '-<br>-', 'CO394'),
('thursday', 'CO406<br>', 'CO451<br>', 'CO207<br>', 'CO309<br>ML11', '-<br>-', 'CO393'),
('friday', '-<br>-', '-<br>-', 'CO309<br>ML11', 'CO406<br>', '-<br>-', 'CO292'),
('saturday', 'CO451<br>', 'CO207<br>', 'CO406<br>', '-<br>-', '-<br>-', '-');
...
('monday', '-<br>-', 'CO431<br>', '-<br>-', '-<br>-', '-<br>-', 'CO393'),
('tuesday', '-<br>-', '-<br>-', '-<br>-', '-<br>-', '-<br>-', '-'),
('wednesday', 'CO431<br>', '-<br>-', '-<br>-', '-<br>-', '-<br>-', 'CO394'),
('thursday', '-<br>-', '-<br>-', '-<br>-', 'CO431<br>', '-<br>-', 'CO393'),
('friday', '-<br>-', 'CO431<br>', '-<br>-', '-<br>-', '-<br>-', '-'),
('saturday', '-<br>-', '-<br>-', '-<br>-', '-<br>-', '-<br>-', '-');
...
--
-- Table structure for table `t00777`
--
-- Error reading structure for table ttms.t00777: #1932 - Table 'ttms.t00777' doesn't exist in engine
-- Error reading data for table ttms.t00777: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'FROM `ttms`.`t00777`' at line 1
...
--
-- Table structure for table `t025`
--
-- Error reading structure for table ttms.t025: #1932 - Table 'ttms.t025' doesn't exist in engine
-- Error reading data for table ttms.t025: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'FROM `ttms`.`t025`' at line 1

-- --------------------------------------------------------

--
-- Table structure for table `t07654`
--
-- Error reading structure for table ttms.t07654: #1932 - Table 'ttms.t07654' doesn't exist in engine
-- Error reading data for table ttms.t07654: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'FROM `ttms`.`t07654`' at line 1
...
('T005', 'Dr. Rashid Ali', 'RA', 'Associate Professor', '12345678', 'rashidali@gmail.com', '123456', ''),
('T004', 'Prof. M.M. Sufyan Beg', 'SB', 'Professor', '12345678', 'mmsufyanbeg@gmail.com', '123456', ''),
('T002', 'Prof. Nesar Ahmad', 'NA', 'Professor', '12345678', 'nesarahmad@gmail.com', '123456', ''),
('T003', 'Prof. Ash Mohammad Abbas', 'AMA', 'Professor', '12345678', 'ashmabbas@gmail.com', '123456', ''),
('T001', 'Prof. Mohammad Sarosh Umar', 'MSU', 'Professor', '12345678', 'saroshumar@gmail.com', '123456', ''),
('T00777', 'asdfgh', 'MTY', 'Guest Faculty', 'vlkuvalfua', 'abc@gmail.com', '9876543210', 'kjshcsygylkvyf'),
('T07654', 'tetgdka', 'JNT', 'Professor', 'password', 'xyz@gmail.com', '978646831143', 'hno43/253j-10q,amrita university kurnool');
...
--
-- Indexes for table `a204`
--
ALTER TABLE `a204`
  ADD PRIMARY KEY (`day`);

--
-- Indexes for table `b203`
--
ALTER TABLE `b203`
  ADD PRIMARY KEY (`day`);

--
-- Indexes for table `c403`
--
ALTER TABLE `c403`
  ADD PRIMARY KEY (`day`);
